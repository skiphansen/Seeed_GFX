#pragma message "Defines included"
...
#define EPD_PUSH_NEW_COLORS(w, h, colors)   \
    do                                      \
    {                                       \
       LOG("Custom EPD_PUSH_NEW_COLORS called\n"); \
...
#define EPD_PUSH_NEW_COLORS_FLIP(w, h, colors)                         \
    do                                                                 \
    {                                                                  \
       LOG("Custom EPD_PUSH_NEW_COLORS_FLIP called\n"); \
        uint16_t bytes_per_row = (w) / 2;                              \
        uint8_t temp1, temp2, temp3, temp4;               \
        writecommand(0x10);                                            \
        for (uint16_t row = 0; row < (h); row++)                       \
